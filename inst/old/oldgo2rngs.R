...
#' @examples
#' src_o = Organism.dplyr::src_organism(TxDb.Hsapiens.UCSC.hg19.knownGene::TxDb.Hsapiens.UCSC.hg19.knownGene)
#' go2ranges(src_o=src_o)
go2ranges_OLD = function (iniGO = "oxidoreductase activity", src_o, gobasis = "id_go_all", ont = "MF", BPini = "A-L") {
    require(GO.db)
